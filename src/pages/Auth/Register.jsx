    ...
    <div className="auth-split-layout" style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', minHeight: '100vh', backgroundColor: '#ffffff' }}>
      ...
      <div className="auth-form-side" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px' }}>
        <div className="auth-card-clean" style={{ width: '100%', maxWidth: '400px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: '700', color: '#1e293b', marginBottom: '25px', textAlign: 'center' }}>Create Account</h2>
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="form-group" style={{ marginBottom: '15px' }}>
              <label style={{ fontSize: '12px', color: '#64748b', fontWeight: '600', marginBottom: '6px', display: 'block' }}>Full Name</label>
              <input 
                type="text" 
                name="name"
                value={formData.name} 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '20px', fontSize: '12px' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', color: '#64748b', fontWeight: '600' }}>
                <input type="checkbox" defaultChecked style={{ accentColor: '#138a36' }} /> I accept <span style={{ color: '#138a36' }}>Terms and Conditions</span>
              </label>
            </div>
          ...
          <p style={{ marginTop: '25px', textAlign: 'center', fontSize: '13px', color: '#64748b' }}>
            Already have an account? <Link to="/auth/login" style={{ color: '#138a36', fontWeight: '700', textDecoration: 'none' }}>Login</Link>
          </p>
        </div>
      </div>
    </div>
